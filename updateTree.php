...
switch ($data['task'])
{
    ...
    break;
    case "remove":
        $query .= "DELETE FROM `internet-clients_datatrees` WHERE `id`='" . $dblink->real_escape_string(htmlspecialchars($data["id"])) . "';";
    break;
    case "update":
        $query .= "UPDATE `internet-clients_datatrees` SET `" . $dblink->real_escape_string(htmlspecialchars($data["property"])) . "`='" . $dblink->real_escape_string(htmlspecialchars($data["value"])) . "' WHERE `id`='" . $dblink->real_escape_string(htmlspecialchars($data["id"])) . "';";
    break;
    default:
