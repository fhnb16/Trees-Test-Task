...
async function editRequestFunc(event){
    ...
    switch(event.target.querySelector('.updateBtn').getAttribute("data-prop")){
    	case "title": await UpdateRequest(event.target.getAttribute("data-id"), "update", event.target.querySelector('.updateBtn').getAttribute("data-prop"), editWindow.querySelector('.modalBody input[name="'+event.target.querySelector('.updateBtn').getAttribute("data-prop")+'"]'));
    	break;
    	case "description": await UpdateRequest(event.target.getAttribute("data-id"), "update", event.target.querySelector('.updateBtn').getAttribute("data-prop"), editWindow.querySelector('.modalBody input[name="'+event.target.querySelector('.updateBtn').getAttribute("data-prop")+'"]'));
    	break;
    	case "parent": await UpdateRequest(event.target.getAttribute("data-id"), "update", event.target.querySelector('.updateBtn').getAttribute("data-prop"), editWindow.querySelector('.modalBody input[name="'+event.target.querySelector('.updateBtn').getAttribute("data-prop")+'"]'));
    	break;
    	case "remove": await UpdateRequest(event.target.getAttribute("data-id"), "remove", event.target.querySelector('.updateBtn').getAttribute("data-prop"), editWindow.querySelector('.modalBody input[name="'+event.target.querySelector('.updateBtn').getAttribute("data-prop")+'"]'));
    	break;
    }
...
async function addRequestFunc(event){
    ...
    await UpdateRequest(null, "add", null, {"title": addForm.querySelector(".addTitle").value, "description": addForm.querySelector(".addDescription").value, "parent": addForm.querySelector(".addParent").value});
	...
	switch(task){
    	...
    	case "add": 
			params = {
			    ...
			    task: task,
			    property: property,
			    value: {"title":val.title, "description":val.description, "parent":val.parent}
			};
    	break;
    }
